...
sub validate_source {    ## no critic
    ...
    for my $Line ( split( /\n/, $Code ) ) {
        ...
        if (
            ...
            && $Line
            !~ m{\A \s* use \s+ (?: vars | constant | strict | warnings | Data (?! ::Validate ) | threads | Readonly | lib | FindBin | IO::Socket | File::Basename | Moo | Perl::Critic::Utils | List::Util | Cwd | POSIX ) }xms
            )
        {
