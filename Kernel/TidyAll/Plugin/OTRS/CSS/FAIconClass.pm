# --
# TidyAll/Plugin/OTRS/CSS/FAIconClass.pm - code quality plugin
...
package TidyAll::Plugin::OTRS::CSS::FAIconClass;
    ...
    for my $Line ( split /\n/, $Code ) {
        ...
        if ( $Line =~ m{\.icon-(.+?) [ ] .* \{}msxi ) {
            if ( $Icons{ 'icon-' . $1 } ) {
                ...
                # notice that normally in css 'fa fa-<name>' is not needed but just 'fa-<name>
                $ErrorMessage
